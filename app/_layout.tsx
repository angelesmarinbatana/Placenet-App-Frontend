...
export default function RootLayout() {
  return (
    //PAGES IN APP: 
    <Stack>
      <Stack.Screen name="index" options={{ title: 'Welcome', headerShown: false, gestureEnabled: false }} />
      ...
      <Stack.Screen name="sign_in" options={{ title: 'Sign In', headerShown: false, gestureEnabled: false }} />
      <Stack.Screen name="sign_up" options={{ title: 'Sign Up', headerShown: false, gestureEnabled: false }} />
      <Stack.Screen name="listing_summaries" options={{ title: 'Social Project Summaries' }} />
      <Stack.Screen name="navigation_bar" options={{ title: 'Back', headerShown: false, gestureEnabled: false }} />
